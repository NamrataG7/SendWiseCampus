...
/**
 * Empty-state shown on the wellbeing-team dashboard home when the signed-in
 * wellbeing-team member has zero students linked. Replaces the fake sample
 * data that previously rendered for brand-new accounts.
 */
    ...
    <div className="max-w-2xl mx-auto mt-8">
      <div className="bg-white rounded-2xl shadow-md border border-gray-200 p-10 text-center">
        ...
        <p className="text-gray-600 mb-8 leading-relaxed">
          To start monitoring, ask the student to open the SendWise keyboard
          app → <strong>Settings</strong> → <strong>Wellbeing Team Link</strong> →{' '}
