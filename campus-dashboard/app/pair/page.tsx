  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">Link a student device</h1>
          <p className="text-sm text-gray-500 mt-1">
            Enter the 6-digit code shown in the SendWise keyboard on the student&apos;s device.
          </p>
        </div>

        {success ? (
          <div className="text-sm text-green-700 bg-green-50 border border-green-100 rounded-lg px-4 py-3">
            Student device linked. Redirecting to your dashboard…
          </div>
        ) : (
