...
export const metadata = {
  ...
  description:
    'Aggregated behavioral risk indicators from the SendWise campus dashboard.',
};
      ...
      <header className="w-full bg-white border-b border-[#ECEEF3] px-8 py-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[14px] text-[#6B7280]">Wellbeing Team Dashboard</div>
          </div>
        </div>
        <Link
          href="/"
        ...
        {!hasChildren && (
          ...
          >
            <div>
              ...
              <p className="text-[14px] text-[#6B7280] mt-1">
                Link a student device to start seeing real behavioral insights.
