        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Wellbeing Team Dashboard — {parentLabel}</p>
            </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                ...
                a guarantee of complete safety. Wellbeing team supervision remains essential.
              </p>
            </div>
          </div>
        </div>
        ...
        {showEmptyIncidentsMessage && (
          <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
            ...
            <p className="text-gray-600">
              The dashboard will populate as the student uses SendWise.
            </p>
          </div>
        )}
      ...
      <footer className="bg-white border-t mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between text-sm text-gray-600">
            <p>SendWise Campus Dashboard v0.1</p>
